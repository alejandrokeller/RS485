...
```
cd existing_repo
git remote add origin https://gitlab.fhnw.ch/alejandrokeller/rs485logger.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.fhnw.ch/alejandrokeller/rs485logger/-/settings/integrations)
